...
const unisWithUni = universities.filter(university =>
  university.split(" ").some(word => word.slice(0, 3).toLowerCase() === "uni")
);

console.log('List of universities with "uni" in the name: ', unisWithUni);
console.log(
  `Number of universities with "uni" in the name: ${unisWithUni.length}`
);
